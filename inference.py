...
garbage = []
def detect(image):
    model = YOLO("C:\\Users\\22596\\Documents\AI\\Underwater-Waste-Detection-Using-YoloV8-And-Water-Quality-Assessment\models\\Underwater_Waste_Detection_YoloV8\\60_epochs_denoised.pt")
